...
async function seedBusinessmen() {
    ...
    const businessmenData = [
        { name: "Comerciante 1", city: "Bogotá", phone: "+57 3101234567", email: "comer1@email.com", status: client_1.Statuses.ACTIVE, date: "2025-03-14" },
        { name: "Comerciante 2", city: "Medellín", phone: "+57 3209876543", email: "comer2@email.com", status: client_1.Statuses.ACTIVE, date: "2025-03-15" },
        { name: "Comerciante 3", city: "Cali", phone: "+57 3005671234", email: "comer3@email.com", status: client_1.Statuses.INACTIVE, date: "2025-03-16" },
    ];
